      ...
      <div v-if="modelValue" class="modal-overlay" @click.self="close">
        <div class="modal-content">
          ...
          <div class="modal-actions-vertical">
            <button class="action-btn primary" :disabled="isLoading" @click="handleGoNextSchedule">
...
const emit = defineEmits<{
  ...
  (e: 'action', payload: { action: NextScheduleAction; remember: boolean }): void;
}>();
