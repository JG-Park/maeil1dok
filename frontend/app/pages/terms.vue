    ...
    <div class="container">
      ...
      <main class="main-content">
        <div class="card fade-in" style="animation-delay: 0.1s">
          ...
          <p class="page-subtitle">서비스 이용약관</p>
          ...
          <div class="legal-content">
            ...
            <section class="legal-section">
              <h2>제7조 (서비스 이용제한)</h2>
              <p>회사는 회원이 다음에 해당하는 경우 서비스 이용을 제한하거나 회원자격을 상실시킬 수 있습니다:</p>
              <ul>
                <li>본 약관을 위반한 경우</li>
            ...
            <section class="legal-section">
              <h2>제10조 (고객센터)</h2>
              <p>서비스 이용 관련 문의는 아래 연락처로 문의해 주세요:</p>
              <ul>
            ...
            <section class="legal-section">
              <h2>부칙</h2>
              <p class="effective-date">본 약관은 2025년 1월 1일부터 시행합니다.</p>
            </section>
          </div>
        </div>
...
useHead({
  title: '이용약관 - 매일일독',
  meta: [
    { name: 'description', content: '매일일독 서비스의 이용약관입니다.' },
    { property: 'og:title', content: '이용약관 - 매일일독' },
    { property: 'og:description', content: '매일일독 서비스의 이용약관입니다.' },
    { property: 'og:url', content: 'https://maeil1dok.app/terms' },
