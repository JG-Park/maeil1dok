          ...
          <Transition name="slide">
            <div v-if="isOpen" class="menu-panel">
              ...
              <nav class="menu-items">
                <NuxtLink to="/reading" class="menu-item" @click="close">
                ...
                <NuxtLink to="/reading-plan" class="menu-item" @click="close">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NuxtLink to="/video" class="menu-item" @click="close">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NuxtLink to="/intro" class="menu-item" @click="close">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
